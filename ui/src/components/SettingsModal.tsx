...
export function SettingsModal({
  ...
  return <div className="settings-backdrop" role="dialog" aria-modal="true" aria-label={t.settings}>
    <section className="settings-modal">
      ...
      {!onboarding && <section className="settings-about"><h3>{t.about}</h3><dl><div><dt>{t.version}</dt><dd>1.0.0</dd></div><div><dt>{t.developers}</dt><dd>SterTheStar</dd></div></dl><small>{t.protocolCredits}</small></section>}
